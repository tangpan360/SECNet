def print_args(args):
    ...
    print(f'  {"SECNet Topk:":<20}{args.topk:<20}{"Patch Size:":<20}{args.patch_size:<20}')
    print(f'  {"Patch Stride:":<20}{args.stride:<20}{"Kernel Size:":<20}{args.kernel_size:<20}')
    print(f'  {"Num Channels:":<20}{", ".join(map(str, args.num_channels)):<20}')
    print()
    ...
    print(f'  {"Use DTW:":<20}{args.use_dtw:<20}{"Aug Ratio:":<20}{args.augmentation_ratio:<20}')
    print()
